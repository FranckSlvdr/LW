  ...
  return (
    <main className="flex-1 overflow-y-auto">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6">
        ...
        {/* TrainSelector + Settings — desktop only (actions trop complexes pour mobile) */}
        ...
        {/* Train history — visible on all breakpoints */}
...
function TrainsSkeleton() {
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-4 md:py-6 space-y-4 md:space-y-6">
        {/* TrainSelector + Settings — desktop only, matches actual content */}
        <div className="hidden md:block">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* TrainHistory — visible on all breakpoints */}
